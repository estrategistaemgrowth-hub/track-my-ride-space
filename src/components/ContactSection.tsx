    ...
    <section id="contato" className="py-24 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div ref={gridRef} className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-primary flex items-center justify-center group-hover:bg-secondary transition-colors duration-300">
          ...
          <div
            className={`bg-background rounded-2xl p-8 text-center shadow-lg card-lift reveal-scale ${gridVisible ? "visible" : ""}`}
