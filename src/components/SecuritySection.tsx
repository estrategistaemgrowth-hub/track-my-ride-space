  ...
  <section id="seguranca" className="py-24 bg-background">
    <div className="container mx-auto px-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((f) => (
          <div key={f.title} className="relative bg-primary rounded-2xl p-8 text-center overflow-hidden group">
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-primary-foreground/10 flex items-center justify-center group-hover:scale-110 transition-transform">
