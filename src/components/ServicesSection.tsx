...
const services = [
  {
    ...
    desc: "Ideal para menores volumes, compartilhando o veículo com outras cargas.",
  },
  {
    icon: Truck,
    title: "Carga Lotação",
    desc: "Veículo exclusivo para um único embarcador.",
  },
  {
    icon: Settings,
    title: "Carga Dedicada",
    desc: "Operação customizada conforme a necessidade do cliente.",
  },
  {
    icon: Zap,
    title: "Serviço Expresso",
    desc: "Solução rápida para cargas urgentes, com prioridade na coleta e entrega.",
  },
];
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {services.map((s) => (
          <div
            key={s.title}
            className="bg-primary-foreground/5 border border-primary-foreground/10 rounded-2xl p-8 hover:bg-primary-foreground/10 transition group"
          >
            <div className="w-16 h-16 rounded-xl bg-secondary/20 flex items-center justify-center mb-6 group-hover:bg-secondary/30 transition">
